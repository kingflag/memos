              ...
              >
                {aiPlatforms.map((platform) => (
                  <ListItem key={platform.id}>
                    <ListItemButton onClick={() => handleSelectPlatform(platform)} selected={selectedPlatform?.id === platform.id}>
                      <div className="flex flex-col">
                        <span>{platform.displayName}</span>
                        <span className="text-xs text-gray-500">{platform.platformType}</span>
                      </div>
                    </ListItemButton>
                  </ListItem>
                ))}
