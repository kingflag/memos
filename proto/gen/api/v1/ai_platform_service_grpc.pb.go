...
const (
	...
	AIPlatformService_ListPlatformTypes_FullMethodName = "/memos.api.v1.AIPlatformService/ListPlatformTypes"
...
type AIPlatformServiceClient interface {
	...
	ListPlatformTypes(ctx context.Context, in *ListPlatformTypesRequest, opts ...grpc.CallOption) (*ListPlatformTypesResponse, error)
...
func (c *aIPlatformServiceClient) ListPlatformTypes(ctx context.Context, in *ListPlatformTypesRequest, opts ...grpc.CallOption) (*ListPlatformTypesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListPlatformTypesResponse)
	err := c.cc.Invoke(ctx, AIPlatformService_ListPlatformTypes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AIPlatformServiceServer interface {
	...
	// List all available platform types
	ListPlatformTypes(context.Context, *ListPlatformTypesRequest) (*ListPlatformTypesResponse, error)
	// Get a specific AI platform
...
func (UnimplementedAIPlatformServiceServer) ListPlatformTypes(context.Context, *ListPlatformTypesRequest) (*ListPlatformTypesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListPlatformTypes not implemented")
}
...
func _AIPlatformService_ListPlatformTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListPlatformTypesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AIPlatformServiceServer).ListPlatformTypes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AIPlatformService_ListPlatformTypes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AIPlatformServiceServer).ListPlatformTypes(ctx, req.(*ListPlatformTypesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AIPlatformService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListPlatformTypes",
			Handler:    _AIPlatformService_ListPlatformTypes_Handler,
		},
		{
